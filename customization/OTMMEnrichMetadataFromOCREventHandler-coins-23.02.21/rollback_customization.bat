...
Echo Deleting OTMMEnrichMetadataFromOCREventHandler-coins-23.02.21.jar from %TEAMS_HOME%
...
del /Q %TEAMS_HOME%\\plugins\\OTMMEnrichMetadataFromOCREventHandler-coins-23.02.21.jar
...
if exist %TOMEE_HOME% (
	...
	del /Q %TEAMS_HOME%\\ear\\artesia\\lib\\OTMMEnrichMetadataFromOCREventHandler-coins-23.02.21.jar
)
